...
<form action="update" method="post">
	<table align="center" border="1">
		...
		<tr>
			<td>性别</td>
			<td><select name="sex">
				<option value="男" ${s.sex eq "男"?'selected':''}>男</option>
				<option value="女" ${s.sex eq "女"?'selected':''}>女</option>
			</select></td>
		</tr>
		<tr>
			<td>年龄</td>
			<td><input name="age" type="text" id="age" value="${s.age}"></td>
			<td><span id="checkAge"></span></td>
		</tr>
		<tr>
			<td>职位</td>
			<td><input type="text" name="position" id="position" value="${s.position}"></td>
			<td><span id="checkPosition"></span></td>
		</tr>
		<tr>
			<td>
			<input type="hidden" name="id" value="${s.id}">
			<input value="提交" type="submit" onclick="return check();"></td>
